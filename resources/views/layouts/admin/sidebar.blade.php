<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html">Sahabat Bk</a>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
          <a href="https://github.com/Ichaputriadestiani/Ichaputriadestiani.github.io" target="_blank" class="btn btn-primary btn-lg btn-block btn-icon-split">
